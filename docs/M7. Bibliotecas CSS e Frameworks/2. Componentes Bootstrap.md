...
A class `navbar-expand-lg` indica o breakpoint a partir do qual o menu passa de hamburger a uma lista de items. A class`navbar-toggler` indica que o elemento faz a abertura e fecho do menu em mobile.

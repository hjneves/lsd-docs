Instalação e gestão de plugins. Alguns plugins recomendados.
# Instalação
...
2. Aumentar o limite do tempo de execução dos scripts php, bem como os limits de upload e de post
...
O plugin [All-in-One Wp Migration and Backup](https://wordpress.org/plugins/all-in-one-wp-migration/) ou o [WP Migrate Lite](https://wordpress.org/plugins/wp-migrate-db/) são muito úteis para a gestão de sites WordPress, nomeadamente para enviar um site de uma instalação para outro domínio ou outra máquina de desenvolvimento.
...
[Create Block Theme](https://wordpress.org/plugins/create-block-theme/) permite a criação de um tema em branco ou a partir de outro.
...
[Carousel for FSE](https://wordpress.org/plugins/carousel-block/) permite a criação de sliders. É baseado no swiper.

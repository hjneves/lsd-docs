Criar exemplo de modelo ER com relações 1:n e n:m no mysqlworkbench

Usar o modelo de dados e o  ficheiro de dados que estão no projecto github lsd-db-store
